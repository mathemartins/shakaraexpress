...
class NotificationQuerySet(models.query.QuerySet):
    """docstring for NotificationQuerySet"""
...
class Notification(models.Model):
    ...
    def __str__(self):
        ...
        context = {
            ...
            "verify_read": reverse("notify:notifications_read", kwargs={"id": self.id}),
    ...
    def get_link(self):
        try:
            ...
            target_url = reverse("notify:notifications_all")
        context = {
            "sender": self.sender_object,
            "verb": self.verb,
            "action": self.action_object,
